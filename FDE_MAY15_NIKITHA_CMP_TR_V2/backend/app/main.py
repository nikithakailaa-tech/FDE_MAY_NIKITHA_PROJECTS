...
from app.routes import auth, complaints, categories, dashboard, feedback, notifications, attachments, analytics
...
app = FastAPI(
    ...
    description="API for managing customer complaints with ETL Analytics (Phase 2)",
    version="2.0.0"
)
